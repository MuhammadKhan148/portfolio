...
export default function AdminPanel() {
    ...
    const [skills, setSkills] = useState<Skill[]>([
        ...
        { id: "4", name: "Scikit-learn", category: "AI/ML", level: 5 },
        { id: "5", name: "Pandas", category: "AI/ML", level: 5 },
        { id: "6", name: "NumPy", category: "AI/ML", level: 5 },
        { id: "7", name: "Sentiment Analysis", category: "AI/ML", level: 5 },
        { id: "8", name: "Recommender Systems", category: "AI/ML", level: 5 },
        { id: "9", name: "Machine Learning", category: "AI/ML", level: 5 },
        { id: "10", name: "Deep Learning", category: "AI/ML", level: 4 },
        { id: "11", name: "NLP", category: "AI/ML", level: 4 },
        { id: "12", name: "Computer Vision", category: "AI/ML", level: 3 },
        { id: "13", name: "Neural Networks", category: "AI/ML", level: 4 },
        { id: "14", name: "Data Science", category: "AI/ML", level: 4 },
        { id: "15", name: "Statistical Analysis", category: "AI/ML", level: 4 },

        // Frontend Skills (Comprehensive)
        { id: "16", name: "React", category: "Frontend", level: 5 },
        { id: "17", name: "Next.js", category: "Frontend", level: 5 },
        { id: "18", name: "JavaScript", category: "Frontend", level: 5 },
        { id: "19", name: "TypeScript", category: "Frontend", level: 5 },
        { id: "20", name: "HTML5", category: "Frontend", level: 5 },
        { id: "21", name: "CSS3", category: "Frontend", level: 5 },
        { id: "22", name: "SCSS/Sass", category: "Frontend", level: 4 },
        { id: "23", name: "Tailwind CSS", category: "Frontend", level: 5 },
        { id: "24", name: "Material-UI", category: "Frontend", level: 4 },
        { id: "25", name: "Flutter", category: "Frontend", level: 4 },
        { id: "26", name: "React Native", category: "Frontend", level: 4 },
        { id: "27", name: "Vue.js", category: "Frontend", level: 3 },
        { id: "28", name: "Angular", category: "Frontend", level: 3 },
        { id: "29", name: "PWA", category: "Frontend", level: 4 },
        { id: "30", name: "Responsive Design", category: "Frontend", level: 5 },

        // Backend Skills (Extensive)
        { id: "31", name: "Node.js", category: "Backend", level: 5 },
        { id: "32", name: "Express.js", category: "Backend", level: 5 },
        { id: "33", name: "MongoDB", category: "Backend", level: 5 },
        { id: "34", name: "PostgreSQL", category: "Backend", level: 4 },
        { id: "35", name: "MySQL", category: "Backend", level: 4 },
        { id: "36", name: "Firebase", category: "Backend", level: 4 },
        { id: "37", name: "REST APIs", category: "Backend", level: 5 },
        { id: "38", name: "GraphQL", category: "Backend", level: 4 },
        { id: "39", name: "Socket.IO", category: "Backend", level: 4 },
        { id: "40", name: "Redis", category: "Backend", level: 4 },
        { id: "41", name: "JWT", category: "Backend", level: 4 },
        { id: "42", name: "OAuth", category: "Backend", level: 3 },
        { id: "43", name: "Microservices", category: "Backend", level: 3 },
        { id: "44", name: "API Design", category: "Backend", level: 4 },
        { id: "45", name: "Database Design", category: "Backend", level: 4 },

        // DevOps & Tools (Professional)
        { id: "46", name: "Git", category: "DevOps", level: 5 },
        { id: "47", name: "GitHub", category: "DevOps", level: 5 },
        { id: "48", name: "Docker", category: "DevOps", level: 4 },
        { id: "49", name: "Kubernetes", category: "DevOps", level: 3 },
        { id: "50", name: "AWS", category: "DevOps", level: 4 },
        { id: "51", name: "Azure", category: "DevOps", level: 3 },
        { id: "52", name: "GitHub Actions", category: "DevOps", level: 4 },
        { id: "53", name: "CI/CD", category: "DevOps", level: 4 },
        { id: "54", name: "Linux", category: "DevOps", level: 4 },
        { id: "55", name: "Nginx", category: "DevOps", level: 3 },
        { id: "56", name: "Jenkins", category: "DevOps", level: 3 },
        { id: "57", name: "Terraform", category: "DevOps", level: 2 },
        { id: "58", name: "Monitoring", category: "DevOps", level: 3 },
        { id: "59", name: "Testing", category: "DevOps", level: 4 },
        { id: "60", name: "Agile/Scrum", category: "DevOps", level: 4 },
    ])
